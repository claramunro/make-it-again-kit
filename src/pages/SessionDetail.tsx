  ...
  return (
    <div className="flex min-h-screen bg-card">
      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className={cn("fixed bottom-0 right-0 z-20 border-t border-border bg-card px-4 py-3 transition-all duration-300", isMobile ? "left-0" : collapsed ? "left-20" : "left-56")}>
