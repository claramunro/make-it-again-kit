...
export function MobileBottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 flex h-20 items-center justify-around border-t border-border bg-card/95 pb-2 backdrop-blur-sm md:hidden">
      ...
      <button className="flex h-14 w-14 -translate-y-2 items-center justify-center rounded-2xl bg-primary text-2xl text-primary-foreground shadow-lg transition-smooth hover:scale-105 active:scale-95">
        ◯◯
      </button>
